...
def main():
    ...
    outfilename = args.outfilename + '_DD'
    ...
    del tot_freq
    print "RR Calculation"
    
    infilename0 = args.infile2
    infilename1 = args.infile2

    outfilename = args.outfilename + '_RR'
    ...
    print "DR Calculation"
    
    infilename0 = args.infile1
    infilename1 = args.infile2

    outfilename = args.outfilename + '_DR'
